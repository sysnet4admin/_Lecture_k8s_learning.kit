...
echo "127.0.0.1 localhost" > /etc/hosts # localhost name will use by cni
echo "192.168.1.160 cp-k8s" >> /etc/hosts
for (( i=1; i<=$1; i++  )); do echo "192.168.1.16$i w$i-k8s" >> /etc/hosts; done
